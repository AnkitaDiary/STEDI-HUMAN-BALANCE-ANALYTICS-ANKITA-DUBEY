...
step_trainer_landing_node1779689723880 = glueContext.create_dynamic_frame.from_options(format_options={"multiLine": "false"}, connection_type="s3", format="json", connection_options={"paths": ["s3://stedi-s3-bucket-user/step_trainer/landing/"], "recurse": True}, transformation_ctx="step_trainer_landing_node1779689723880")
...
'''
SQLQuery_node1779690237564 = sparkSqlQuery(glueContext, query = SqlQuery0, mapping = {"step_trainer_landing":step_trainer_landing_node1779689723880, "customer_curated":customer_curated_node1779690170348}, transformation_ctx = "SQLQuery_node1779690237564")
